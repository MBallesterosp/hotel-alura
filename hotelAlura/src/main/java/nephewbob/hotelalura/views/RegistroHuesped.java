...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(RegistroHuesped.class.getResource("lOGO-50PX.png")));
		...
		txtFechaN.getCalendarButton().setIcon(new ImageIcon(RegistroHuesped.class.getResource("icon-reservas.png")));
		...
		imagenFondo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("registro.png")));
		
		JLabel logo = new JLabel("");
		logo.setBounds(194, 39, 104, 107);
		panel.add(logo);
		logo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("Ha-100px.png")));
