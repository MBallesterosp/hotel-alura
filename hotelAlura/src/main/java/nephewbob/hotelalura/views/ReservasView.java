...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		txtFechaEntrada.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("icon-reservas.png")));
		...
		txtFechaSalida.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("icon-reservas.png")));
